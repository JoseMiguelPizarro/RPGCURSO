...
Shader "Shadero Customs/Bumped Diffuse both sides with Shadows"
{
Properties
{
...
float2 DistortionUV_2 = DistortionUV(i.texcoord,8.287,30.441,0.422,0.58,0.454);
...
float4 _CircleFade_2 = Circle_Fade(_Generate_Fire_1,i.texcoord,0.5,0.429,0.355,0.2);
float4 _PatternMovementMask_1 = PatternMovementMask(i.texcoord,_SourceNewTex_1,SourceRGBA_1,_CircleFade_2,-0.064,-0.415,2.123);
