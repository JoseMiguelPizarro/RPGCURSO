...
NewTex_4 = lerp(NewTex_4,NewTex_4*NewTex_4.a + _PatternMovement_1*_PatternMovement_1.a,1.5);
...
float4 _PatternMovementMask_1 = PatternMovementMask(i.texcoord,_SourceNewTex_3,SourceRGBA_1,NewTex_3,0.067,-0.613,0.405);
_PatternMovementMask_1.rgb += 4;
float2 AnimatedPingPongOffsetUV_1 = AnimatedPingPongOffsetUV(TwistUV_1,-0.256,-0.868,1.069,1,0.086);
float2 DistortionUV_1 = DistortionUV(AnimatedPingPongOffsetUV_1,4.347,8.942,0.258,0.447,0.546);
float2 AnimatedMouvementUV_1 = AnimatedMouvementUV(DistortionUV_1,0.156,-0.315,0.382);
float4 NewTex_2 = tex2D(_NewTex_2,AnimatedMouvementUV_1);
float4 _Displacement_1 = DisplacementUV(DistortionUV_1,_SourceNewTex_1,0,NewTex_2.g*NewTex_2.a,-0.538);
float4 _Displacement_2 = DisplacementUV(FlipUV_H(DistortionUV_1),_SourceNewTex_1,NewTex_2.r*NewTex_2.a,NewTex_2.g*NewTex_2.a,-0.021);
...
float4 _PremadeGradients_1 = Color_PreGradients(FillColor_1,float4(0.55,0.4,0.3,1),float4(0.5,0.51,0.35,1),float4(0.8,0.75,0.8,1),float4(0.075,0.33,0.67,1),0,0.381,1.026);
float4 OperationBlend_2 = OperationBlend(_PatternMovementMask_1, _PremadeGradients_1, 1); 
float4 OperationBlend_3 = OperationBlend(OperationBlend_2, NewTex_1, 0.701); 
