...
Shader "Shadero Customs/brillo equipamiento 2"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_ShinyFX_Pos_1("_ShinyFX_Pos_1", Range(-1, 1)) = 0
_ShinyFX_Size_1("_ShinyFX_Size_1", Range(-1, 1)) = -0.061
_ShinyFX_Smooth_1("_ShinyFX_Smooth_1", Range(0, 1)) = 0.246
_ShinyFX_Intensity_1("_ShinyFX_Intensity_1", Range(0, 4)) = 0.679
_ShinyFX_Speed_1("_ShinyFX_Speed_1", Range(0, 8)) = 0.964
